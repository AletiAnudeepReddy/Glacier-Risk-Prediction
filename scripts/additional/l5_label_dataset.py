...
# -------------------------------
# APPLY (ONLY ONE LAKE, BUT KEEP SAME LOGIC)
# -------------------------------
group = df.copy()
...
# SAVE
# -------------------------------
output_path = "data/additional/L5_labeled_dataset.csv"
group.to_csv(output_path, index=False)

print(f"🔥 L5 LABELED DATASET READY → {output_path}")