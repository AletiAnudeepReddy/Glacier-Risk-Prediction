...
# -------------------------------
# LAKE CONFIG (L1 - Imja Tsho)
# -------------------------------
lake_id = "L1"

bbox = [86.90, 27.88, 86.96, 27.92]
...
# LOAD LAKE DATA
# -------------------------------
lake_df = pd.read_csv("data/raw/L1_imja_tsho_clean.csv")
...
# SAVE
# -------------------------------
output_path = "data/with_temperature/L1_with_climate.csv"
df.to_csv(output_path, index=False)

print(f"✅ L1 climate dataset saved at: {output_path}")