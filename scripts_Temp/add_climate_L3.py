...
# LOAD LAKE DATA
# -------------------------------
lake_df = pd.read_csv("data/raw/L3_lower_barun_clean.csv")
...
# SAVE
# -------------------------------
output_path = "data/with_temperature/L3_with_climate.csv"
df.to_csv(output_path, index=False)

print(f"✅ L3 climate dataset saved at: {output_path}")