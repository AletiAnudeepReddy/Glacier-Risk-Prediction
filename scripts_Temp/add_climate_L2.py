...
# -------------------------------
# LAKE CONFIG (L2 - Tsho Rolpa)
# -------------------------------
lake_id = "L2"

bbox = [86.44, 27.84, 86.54, 27.92]
...
# LOAD LAKE DATA
# -------------------------------
lake_df = pd.read_csv("data/raw/L2_tsho_rolpa_clean.csv")
...
# SAVE
# -------------------------------
output_path = "data/with_temperature/L2_with_climate.csv"
df.to_csv(output_path, index=False)

print(f"✅ L2 climate dataset saved at: {output_path}")