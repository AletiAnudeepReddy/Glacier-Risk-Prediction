...
# LOAD LAKE DATA
# -------------------------------
lake_df = pd.read_csv("data/raw/L5_gokyo_clean.csv")
...
# SAVE
# -------------------------------
output_path = "data/with_temperature/L5_with_climate.csv"
df.to_csv(output_path, index=False)

print(f"✅ L5 climate dataset saved at: {output_path}")